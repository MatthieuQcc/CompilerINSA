...
HD_PWD='/home/oberry/4IR/S2/SystemeInfo/CompilerINSA/project_reg/project_reg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestUAL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestUAL.tcl -notrace

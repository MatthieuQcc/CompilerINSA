...
HD_PWD='/home/oberry/4IR/S2/SystemeInfo/CompilerINSA/compiler_fpga/compiler_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compiler_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compiler_fpga.tcl
